...
import '../styles/quensions.css'
const Questions = () => {
  return (
    <div>
        <div className="container">
            <h2 className='frequently'>Frequently Asked Quensions</h2>
            <p>Here are some of our FAQs. If you have any <br/> other questions you'd like answered please <br/>feel free to email us.</p>
